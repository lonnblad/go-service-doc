...
// 2021-02-26 23:51:23.203463 +0100 CET m=+0.077043586
package docs
    ...
    <div class="menu-container">
      ...
      <ul>
        ...
        <li><a href="/bars/monkey-bar#monkey">Monkey Bar</a>
          <ul>
            <li><a href="/bars/monkey-bar#lists">Lists</a></li>
          </ul>
        </li>
      </ul>
    </div>
...
<pre style="color:#f8f8f2;background-color:#272822">{
  ...
  <span style="color:#f92672">&#34;s&#34;</span>: <span style="color:#e6db74">&#34;&#34;</span>
	...
	doc = document{
		Link:    "/bars/monkey-bar#lists",
		Context: []string{ `Bars`, `Monkey Bar`, `Lists`, },
		Content: []string{ `Lists`, },
		HTML: `<h2 id="lists">Lists</h2>`,
	}

	if err = searchIndex.Index("/bars/monkey-bar#lists", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/bars/monkey-bar#ordered-list",
...
<li>Fourth list item<br />
	...
	if err = searchIndex.Index("/bars/monkey-bar#ordered-list", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/bars/monkey-bar#unordered-list",
...
<li>Fourth list item<br />
	...
	if err = searchIndex.Index("/bars/monkey-bar#unordered-list", doc); err != nil {
		return
	}
