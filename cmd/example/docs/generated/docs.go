...
// 2020-01-26 15:45:53.539242 -0300 -03 m=+0.005916045
package docs
...
func Handler() http.Handler {
	...
	mux.HandleFunc("/docs/service", serviceHandler)
	mux.HandleFunc("/docs/service/donkey-bar", donkeyBarHandler)
	mux.HandleFunc("/docs/service/monkey-bar", monkeyBarHandler)
	mux.HandleFunc("/docs/service/static/bars.svg", barsHandler)
  ...
  <div class="flex-container">
	<div class="menu-container">
      <ul>
        ...
        <li><a href="/docs/service#animal_bars">Animal Bars</a>
        </li>
        ...
        <li><a href="/docs/service/donkey-bar#donkey">Donkey Bar</a>
        <ul>
            
            <li><a href="/docs/service/donkey-bar#code_examples">Code Examples</a></li>
        ...
        <li><a href="/docs/service/monkey-bar#monkey">Monkey Bar</a>
        <ul>
            
            <li><a href="/docs/service/monkey-bar#code_examples">Code Examples</a></li>
    ...
    <div class="doc-container">
      <h1 id="animal_bars">Animal Bars</h1>
...
// nolint: golint
func donkeyBarHandler(w http.ResponseWriter, req *http.Request) {
	w.Header().Set(contentType, mimeHTML)
...
// nolint: golint
func monkeyBarHandler(w http.ResponseWriter, req *http.Request) {
	w.Header().Set(contentType, mimeHTML)
...
// nolint: golint
func barsHandler(w http.ResponseWriter, req *http.Request) {
