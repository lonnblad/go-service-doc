...
// 2021-02-26 23:04:31.967948 +0100 CET m=+0.077597475
package docs
...
<head>
  ...
  <link rel="stylesheet" href="/bars/markdown.css">
</head>
  ...
  <div class="flex-container">
    <div class="menu-container">
      <div  class=menu-header>
        <h1>Bars</h1>
        <form class=menu-search action="/bars/search" method="get">
      ...
      <ul>
        <li><a href="/bars#bars">Bars</a></li>
        <li><a href="/bars/donkey-bar#donkey">Donkey Bar</a>
          <ul>
            <li><a href="/bars/donkey-bar#code_examples">Code Examples</a></li>
          </ul>
        </li>
        <li><a href="/bars/monkey-bar#monkey">Monkey Bar</a>
          <ul>
            <li><a href="/bars/monkey-bar#list">Lists</a></li>
          </ul>
        </li>
      </ul>
    </div>
...
<h3 id="go">go</h3>
<pre style="color:#f8f8f2;background-color:#272822"><span style="color:#f92672">import</span> <span style="color:#e6db74">&#34;fmt&#34;</span>

<span style="color:#66d9ef">func</span> <span style="color:#a6e22e">main</span>() {
     <span style="color:#a6e22e">fmt</span>.<span style="color:#a6e22e">Println</span>(<span style="color:#e6db74">&#34;hej&#34;</span>)
}
...
<h3 id="orderlist">Ordered list</h3>
...
<pre style="color:#f8f8f2;background-color:#272822">{
  ...
  <span style="color:#f92672">&#34;s&#34;</span>: <span style="color:#e6db74">&#34;&#34;</span>
	...
	if err = searchIndex.Index("/bars/donkey-bar#json", doc); err != nil {
		return
	}
	...
	doc = document{
		Link:    "/bars/monkey-bar#list",
		Context: []string{ `Bars`, `Monkey Bar`, `Lists`, },
		Content: []string{ `Lists`, },
		HTML: `<h2 id="list">Lists</h2>`,
	}

	if err = searchIndex.Index("/bars/monkey-bar#list", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/bars/monkey-bar#orderlist",
...
<li>Fourth list item<br />
	...
	if err = searchIndex.Index("/bars/monkey-bar#orderlist", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/bars/monkey-bar#unorderedlist",
...
<li>Fourth list item<br />
	...
	if err = searchIndex.Index("/bars/monkey-bar#unorderedlist", doc); err != nil {
		return
	}
