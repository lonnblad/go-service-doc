...
// 2020-02-01 14:38:27.431022 -0300 -03 m=+0.006304962
package docs
...
func Handler() http.Handler {
	...
	mux.HandleFunc("/docs/service/donkeyBar", donkeyBarPageHandler)
	mux.HandleFunc("/docs/service/monkeyBar", monkeyBarPageHandler)
...
func servicePageHandler(w http.ResponseWriter, req *http.Request) {
	...
	// nolint: errcheck
	w.Write([]byte(`<!DOCTYPE html><html lang=en><head><title>Animal Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/docs/service/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Animal Bars</h1><form class=menu-search action="/docs/service/search" method="get"><input 
			type="text"
			placeholder="Search.."
			name="q"
			value=""
			onfocus="var temp_value=this.value; this.value=''; this.value=temp_value"
			autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/docs/service#animal_bars">Animal Bars</a></li><li><a href="/docs/service/donkeyBar#donkey">Donkey Bar</a><ul><li><a href="/docs/service/donkeyBar#code_examples">Code Examples</a></li></ul></li><li><a href="/docs/service/monkeyBar#monkey">Monkey Bar</a><ul><li><a href="/docs/service/monkeyBar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><h1 id="animal_bars">Animal Bars</h1><p><img src="/docs/service/static/bars.svg" alt="The bars" /></p></div></div></body></html>`))
}
...
func donkeyBarPageHandler(w http.ResponseWriter, req *http.Request) {
	...
	w.Write([]byte(`<!DOCTYPE html><html lang=en><head><title>Animal Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/docs/service/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Animal Bars</h1><form class=menu-search action="/docs/service/search" method="get"><input 
			...
			value=""
			onfocus="var temp_value=this.value; this.value=''; this.value=temp_value"
			autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/docs/service#animal_bars">Animal Bars</a></li><li><a href="/docs/service/donkeyBar#donkey">Donkey Bar</a><ul><li><a href="/docs/service/donkeyBar#code_examples">Code Examples</a></li></ul></li><li><a href="/docs/service/monkeyBar#monkey">Monkey Bar</a><ul><li><a href="/docs/service/monkeyBar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><h1 id="donkey">Donkey Bar</h1><h2 id="code_examples">Code Examples</h2><h3 id="go">go</h3><pre><code class="language-go">var i = 0
...
func monkeyBarPageHandler(w http.ResponseWriter, req *http.Request) {
	...
	w.Write([]byte(`<!DOCTYPE html><html lang=en><head><title>Animal Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/docs/service/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Animal Bars</h1><form class=menu-search action="/docs/service/search" method="get"><input 
			...
			value=""
			onfocus="var temp_value=this.value; this.value=''; this.value=temp_value"
			autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/docs/service#animal_bars">Animal Bars</a></li><li><a href="/docs/service/donkeyBar#donkey">Donkey Bar</a><ul><li><a href="/docs/service/donkeyBar#code_examples">Code Examples</a></li></ul></li><li><a href="/docs/service/monkeyBar#monkey">Monkey Bar</a><ul><li><a href="/docs/service/monkeyBar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><h1 id="monkey">Monkey Bar</h1><h2 id="code_examples">Code Examples</h2><h3 id="go">go</h3><pre><code class="language-go">var i = 0
</code></pre><h3 id="js">js</h3><pre><code class="language-javascript">let i = 0
</code></pre></div></div></body></html>`))
}
...
<p><img src="/docs/service/static/bars.svg" alt="The bars" /></p>`,
	}
	...
	doc = document{
		Link:    "/docs/service/donkeyBar#donkey",
		Context: []string{ `Animal Bars`, `Donkey Bar`, },
		Content: []string{ `Donkey Bar`, },
		HTML: `<h1 id="donkey">Donkey Bar</h1>`,
	}

	if err = searchIndex.Index("/docs/service/donkeyBar#donkey", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/service/donkeyBar#code_examples",
		Context: []string{ `Animal Bars`, `Donkey Bar`, `Code Examples`, },
		Content: []string{ `Code Examples`, },
		HTML: `<h2 id="code_examples">Code Examples</h2>`,
	}

	if err = searchIndex.Index("/docs/service/donkeyBar#code_examples", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/service/donkeyBar#go",
...
<pre><code class="language-go">var i = 0
	...
	if err = searchIndex.Index("/docs/service/donkeyBar#go", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/service/donkeyBar#js",
...
<pre><code class="language-javascript">let i = 0
	...
	if err = searchIndex.Index("/docs/service/donkeyBar#js", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/service/monkeyBar#monkey",
		Context: []string{ `Animal Bars`, `Monkey Bar`, },
		Content: []string{ `Monkey Bar`, },
		HTML: `<h1 id="monkey">Monkey Bar</h1>`,
	}

	if err = searchIndex.Index("/docs/service/monkeyBar#monkey", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/service/monkeyBar#code_examples",
		Context: []string{ `Animal Bars`, `Monkey Bar`, `Code Examples`, },
		Content: []string{ `Code Examples`, },
		HTML: `<h2 id="code_examples">Code Examples</h2>`,
	}

	if err = searchIndex.Index("/docs/service/monkeyBar#code_examples", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/service/monkeyBar#go",
...
<pre><code class="language-go">var i = 0
	...
	if err = searchIndex.Index("/docs/service/monkeyBar#go", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/service/monkeyBar#js",
...
<pre><code class="language-javascript">let i = 0
	...
	if err = searchIndex.Index("/docs/service/monkeyBar#js", doc); err != nil {
		return
	}
...
const searchPage = `<!DOCTYPE html><html lang=en><head><title>Animal Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/docs/service/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Animal Bars</h1><form class=menu-search action="/docs/service/search" method="get"><input 
			...
			value="<query_string>"
			onfocus="var temp_value=this.value; this.value=''; this.value=temp_value"
			autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/docs/service#animal_bars">Animal Bars</a></li><li><a href="/docs/service/donkeyBar#donkey">Donkey Bar</a><ul><li><a href="/docs/service/donkeyBar#code_examples">Code Examples</a></li></ul></li><li><a href="/docs/service/monkeyBar#monkey">Monkey Bar</a><ul><li><a href="/docs/service/monkeyBar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><search_result></div></div></body></html>`
