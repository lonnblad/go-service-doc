...
// 2021-02-10 22:44:02.730717 +0100 CET m=+0.018216257
package docs
...
func barsPageHandler(w http.ResponseWriter, req *http.Request) {
	...
	const content = `<!DOCTYPE html><html lang=en><head><title>Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/docs/service/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Bars</h1><form class=menu-search action="/bars/search" method="get"><input type="text" placeholder="Search.." name="q" value="" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/bars#bars">Bars</a></li><li><a href="/bars/donkey-bar#donkey">Donkey Bar</a><ul><li><a href="/bars/donkey-bar#code_examples">Code Examples</a></li></ul></li><li><a href="/bars/monkey-bar#monkey">Monkey Bar</a><ul><li><a href="/bars/monkey-bar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><h1 id="bars">Bars</h1><p>| Bar Name   | Animal Family |<br />
| &mdash;&mdash;&mdash;- | &mdash;&mdash;&mdash;&mdash;- |<br />
| Donkey Bar | Donkey        |<br />
| Monkey Bar | Monkey        |</p><p><img src="/bars/static/bars.svg" alt="The bars" /></p></div></div></body></html>`
...
func donkeyBarPageHandler(w http.ResponseWriter, req *http.Request) {
	...
	const content = `<!DOCTYPE html><html lang=en><head><title>Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/docs/service/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Bars</h1><form class=menu-search action="/bars/search" method="get"><input type="text" placeholder="Search.." name="q" value="" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/bars#bars">Bars</a></li><li><a href="/bars/donkey-bar#donkey">Donkey Bar</a><ul><li><a href="/bars/donkey-bar#code_examples">Code Examples</a></li></ul></li><li><a href="/bars/monkey-bar#monkey">Monkey Bar</a><ul><li><a href="/bars/monkey-bar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><h1 id="donkey">Donkey Bar</h1><h2 id="code_examples">Code Examples</h2><h3 id="go">go</h3><pre><code class="language-go">var i = 0
...
func monkeyBarPageHandler(w http.ResponseWriter, req *http.Request) {
	...
	const content = `<!DOCTYPE html><html lang=en><head><title>Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/docs/service/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Bars</h1><form class=menu-search action="/bars/search" method="get"><input type="text" placeholder="Search.." name="q" value="" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/bars#bars">Bars</a></li><li><a href="/bars/donkey-bar#donkey">Donkey Bar</a><ul><li><a href="/bars/donkey-bar#code_examples">Code Examples</a></li></ul></li><li><a href="/bars/monkey-bar#monkey">Monkey Bar</a><ul><li><a href="/bars/monkey-bar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><h1 id="monkey">Monkey Bar</h1><h2 id="code_examples">Code Examples</h2><h3 id="go">go</h3><pre><code class="language-go">var i = 0
</code></pre><h3 id="js">js</h3><pre><code class="language-javascript">let i = 0;
</code></pre></div></div></body></html>`
...
func createSearchIndex() (searchIndex bleve.Index, err error) {
	...
	doc = document{
		...
		Content: []string{ `Bars`, `| Bar Name   | Animal Family |
| ---------- | ------------- |
| Donkey Bar | Donkey        |
| Monkey Bar | Monkey        |`, `The bars`, },
		HTML: `<h1 id="bars">Bars</h1>

<p>| Bar Name   | Animal Family |<br />
| &mdash;&mdash;&mdash;- | &mdash;&mdash;&mdash;&mdash;- |<br />
| Donkey Bar | Donkey        |<br />
| Monkey Bar | Monkey        |</p>
...
<pre><code class="language-javascript">let i = 0;
	...
	doc = document{
		...
		Context: []string{ `Bars`, `Monkey Bar`, `Code Examples`, },
		Content: []string{ `Code Examples`, },
		HTML: `<h2 id="code_examples">Code Examples</h2>`,
	}
	...
	doc = document{
		...
		Context: []string{ `Bars`, `Monkey Bar`, `Code Examples`, `go`, },
		Content: []string{ `go`, `go
var i = 0`, },
		HTML: `<h3 id="go">go</h3>
...
<pre><code class="language-go">var i = 0
	...
	doc = document{
		...
		Context: []string{ `Bars`, `Monkey Bar`, `Code Examples`, `js`, },
		Content: []string{ `js`, `javascript
let i = 0;`, },
		HTML: `<h3 id="js">js</h3>
...
const searchPage = `<!DOCTYPE html><html lang=en><head><title>Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/docs/service/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Bars</h1><form class=menu-search action="/bars/search" method="get"><input type="text" placeholder="Search.." name="q" value="<query_string>" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/bars#bars">Bars</a></li><li><a href="/bars/donkey-bar#donkey">Donkey Bar</a><ul><li><a href="/bars/donkey-bar#code_examples">Code Examples</a></li></ul></li><li><a href="/bars/monkey-bar#monkey">Monkey Bar</a><ul><li><a href="/bars/monkey-bar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><search_result></div></div></body></html>`
