...
// 2021-02-13 22:24:46.852768 +0100 CET m=+0.005328013
package docs
...
func Handler() http.Handler {
	...
	mux.HandleFunc("/bars/markdown.css", cssHandler)
	mux.HandleFunc("/bars/search", searchHandler(index))
	mux.HandleFunc("/bars", barsPageHandler)
	mux.HandleFunc("/bars/donkey-bar", donkeyBarPageHandler)
	mux.HandleFunc("/bars/monkey-bar", monkeyBarPageHandler)
	mux.HandleFunc("/bars/static/bars.svg", barsStaticFileHandler)
...
func barsPageHandler(w http.ResponseWriter, req *http.Request) {
	...
	const content = `<!DOCTYPE html><html lang=en><head><title>Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/bars/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Bars</h1><form class=menu-search action="/bars/search" method="get"><input type="text" placeholder="Search.." name="q" value="" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/bars#bars">Bars</a><ul><li><a href="/bars#table">Table</a></li><li><a href="/bars#image">Image</a></li><li><a href="/bars#list">Lists</a></li></ul></li><li><a href="/bars/donkey-bar#donkey">Donkey Bar</a><ul><li><a href="/bars/donkey-bar#code_examples">Code Examples</a></li></ul></li><li><a href="/bars/monkey-bar#monkey">Monkey Bar</a><ul><li><a href="/bars/monkey-bar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><h1 id="bars">Bars</h1><h2 id="table">Table</h2><table><thead><tr><th>Link</th><th>Name</th></tr></thead><tbody><tr><td><a href="/bars/donkey-bar#donkey">Donkey Bar</a></td><td>Donkey</td></tr><tr><td><a href="/bars/monkey-bar#monkey">Monkey Bar</a></td><td>Monkey</td></tr></tbody></table><h2 id="image">Image</h2><p><img src="/bars/static/bars.svg" alt="The bars" /></p><h2 id="list">Lists</h2><h3 id="orderlist">Ordered list</h3><ol><li>First list item<br /></li><li>Second list item<br /><ol><li>Indented list item<br /><ol><li>Indented list item<br /></li><li>Indented list item<br /></li></ol></li><li>Indented list item<br /></li></ol></li><li>Third list item<br /></li><li>Fourth list item<br /></li></ol><h3 id="unorderedlist">Unordered list</h3><ul><li>First list item<br /></li><li>Second list item<br /><ul><li>Indented list item<br /><ul><li>Indented list item<br /></li><li>Indented list item<br /></li></ul></li><li>Indented list item<br /></li></ul></li><li>Third list item<br /></li><li>Fourth list item</li></ul></div></div></body></html>`
...
func donkeyBarPageHandler(w http.ResponseWriter, req *http.Request) {
	...
	const content = `<!DOCTYPE html><html lang=en><head><title>Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/bars/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Bars</h1><form class=menu-search action="/bars/search" method="get"><input type="text" placeholder="Search.." name="q" value="" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/bars#bars">Bars</a><ul><li><a href="/bars#table">Table</a></li><li><a href="/bars#image">Image</a></li><li><a href="/bars#list">Lists</a></li></ul></li><li><a href="/bars/donkey-bar#donkey">Donkey Bar</a><ul><li><a href="/bars/donkey-bar#code_examples">Code Examples</a></li></ul></li><li><a href="/bars/monkey-bar#monkey">Monkey Bar</a><ul><li><a href="/bars/monkey-bar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><h1 id="donkey">Donkey Bar</h1><h2 id="code_examples">Code Examples</h2><h3 id="go">go</h3><pre><code class="language-go">var i = 0
...
func monkeyBarPageHandler(w http.ResponseWriter, req *http.Request) {
	...
	const content = `<!DOCTYPE html><html lang=en><head><title>Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/bars/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Bars</h1><form class=menu-search action="/bars/search" method="get"><input type="text" placeholder="Search.." name="q" value="" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/bars#bars">Bars</a><ul><li><a href="/bars#table">Table</a></li><li><a href="/bars#image">Image</a></li><li><a href="/bars#list">Lists</a></li></ul></li><li><a href="/bars/donkey-bar#donkey">Donkey Bar</a><ul><li><a href="/bars/donkey-bar#code_examples">Code Examples</a></li></ul></li><li><a href="/bars/monkey-bar#monkey">Monkey Bar</a><ul><li><a href="/bars/monkey-bar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><h1 id="monkey">Monkey Bar</h1><h2 id="code_examples">Code Examples</h2><h3 id="go">go</h3><pre><code class="language-go">var i = 0
</code></pre><h3 id="js">js</h3><pre><code class="language-javascript">let i = 0;
</code></pre></div></div></body></html>`
...
func createSearchIndex() (searchIndex bleve.Index, err error) {
	...
	if err = searchIndex.Index("/bars#bars", doc); err != nil {
		return
	}
...
<tbody>
<tr>
<td><a href="/bars/donkey-bar#donkey">Donkey Bar</a></td>
<td>Donkey</td>
</tr>

<tr>
<td><a href="/bars/monkey-bar#monkey">Monkey Bar</a></td>
<td>Monkey</td>
</tr>
</tbody>
</table>`,
	...
	if err = searchIndex.Index("/bars#table", doc); err != nil {
		return
	}
	...
	doc = document{
		Link:    "/bars#image",
		Context: []string{ `Bars`, },
		Content: []string{ `Image`, `The bars`, },
		HTML: `<h2 id="image">Image</h2>

<p><img src="/bars/static/bars.svg" alt="The bars" /></p>`,
	}

	if err = searchIndex.Index("/bars#image", doc); err != nil {
		return
	}
	...
	doc = document{
		...
		HTML: `<h2 id="list">Lists</h2>`,
	}

	if err = searchIndex.Index("/bars#list", doc); err != nil {
		return
	}
	...
	doc = document{
		...
		HTML: `<h3 id="orderlist">Ordered list</h3>
...
<li>Fourth list item<br />
	...
	if err = searchIndex.Index("/bars#orderlist", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/bars#unorderedlist",
		Context: []string{ `Bars`, },
		...
		HTML: `<h3 id="unorderedlist">Unordered list</h3>
...
<li>Fourth list item</li>
	...
	if err = searchIndex.Index("/bars#unorderedlist", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/bars/donkey-bar#donkey",
		Context: []string{ `Bars`, },
		Content: []string{ `Donkey Bar`, },
		HTML: `<h1 id="donkey">Donkey Bar</h1>`,
	}

	if err = searchIndex.Index("/bars/donkey-bar#donkey", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/bars/donkey-bar#code_examples",
		Context: []string{ `Bars`, },
		Content: []string{ `Code Examples`, },
		HTML: `<h2 id="code_examples">Code Examples</h2>`,
	}

	if err = searchIndex.Index("/bars/donkey-bar#code_examples", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/bars/donkey-bar#go",
		Context: []string{ `Bars`, },
...
<pre><code class="language-go">var i = 0
	...
	if err = searchIndex.Index("/bars/donkey-bar#go", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/bars/donkey-bar#js",
		Context: []string{ `Bars`, },
...
<pre><code class="language-javascript">let i = 0;
	...
	if err = searchIndex.Index("/bars/donkey-bar#js", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/bars/monkey-bar#monkey",
		Context: []string{ `Bars`, },
		Content: []string{ `Monkey Bar`, },
		HTML: `<h1 id="monkey">Monkey Bar</h1>`,
	}

	if err = searchIndex.Index("/bars/monkey-bar#monkey", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/bars/monkey-bar#code_examples",
		Context: []string{ `Bars`, },
		Content: []string{ `Code Examples`, },
		HTML: `<h2 id="code_examples">Code Examples</h2>`,
	}

	if err = searchIndex.Index("/bars/monkey-bar#code_examples", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/bars/monkey-bar#go",
		Context: []string{ `Bars`, },
		Content: []string{ `go`, `go
var i = 0`, },
		HTML: `<h3 id="go">go</h3>
...
<pre><code class="language-go">var i = 0
	...
	if err = searchIndex.Index("/bars/monkey-bar#go", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/bars/monkey-bar#js",
		Context: []string{ `Bars`, },
		Content: []string{ `js`, `javascript
let i = 0;`, },
		HTML: `<h3 id="js">js</h3>
...
<pre><code class="language-javascript">let i = 0;
	...
	if err = searchIndex.Index("/bars/monkey-bar#js", doc); err != nil {
		return
	}
...
const searchPage = `<!DOCTYPE html><html lang=en><head><title>Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/bars/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Bars</h1><form class=menu-search action="/bars/search" method="get"><input type="text" placeholder="Search.." name="q" value="<query_string>" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/bars#bars">Bars</a><ul><li><a href="/bars#table">Table</a></li><li><a href="/bars#image">Image</a></li><li><a href="/bars#list">Lists</a></li></ul></li><li><a href="/bars/donkey-bar#donkey">Donkey Bar</a><ul><li><a href="/bars/donkey-bar#code_examples">Code Examples</a></li></ul></li><li><a href="/bars/monkey-bar#monkey">Monkey Bar</a><ul><li><a href="/bars/monkey-bar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><search_result></div></div></body></html>`
