...
// 2021-02-10 10:07:20.774012 +0100 CET m=+0.005176508
package docs
...
func Handler() http.Handler {
	...
	mux.HandleFunc("/docs/apa/markdown.css", cssHandler)
	mux.HandleFunc("/docs/apa/search", searchHandler(index))
	mux.HandleFunc("/docs/apa", servicePageHandler)
	mux.HandleFunc("/docs/apa/donkey-bar", donkeyBarPageHandler)
	mux.HandleFunc("/docs/apa/monkey-bar", monkeyBarPageHandler)
	mux.HandleFunc("/docs/apa/static/animal-bars.svg", animalBarsStaticFileHandler)
...
func servicePageHandler(w http.ResponseWriter, req *http.Request) {
	...
	const content = `<!DOCTYPE html><html lang=en><head><title>Animal Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/docs/apa/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Animal Bars</h1><form class=menu-search action="/docs/apa/search" method="get"><input type="text" placeholder="Search.." name="q" value="" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/docs/apa#animal_bars">Animal Bars</a></li><li><a href="/docs/apa/donkey-bar#donkey">Donkey Bar</a><ul><li><a href="/docs/apa/donkey-bar#code_examples">Code Examples</a></li></ul></li><li><a href="/docs/apa/monkey-bar#monkey">Monkey Bar</a><ul><li><a href="/docs/apa/monkey-bar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><h1 id="animal_bars">Animal Bars</h1><p><img src="/docs/service/static/animal-bars.svg" alt="The bars" /></p></div></div></body></html>`
...
func donkeyBarPageHandler(w http.ResponseWriter, req *http.Request) {
	...
	const content = `<!DOCTYPE html><html lang=en><head><title>Animal Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/docs/apa/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Animal Bars</h1><form class=menu-search action="/docs/apa/search" method="get"><input type="text" placeholder="Search.." name="q" value="" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/docs/apa#animal_bars">Animal Bars</a></li><li><a href="/docs/apa/donkey-bar#donkey">Donkey Bar</a><ul><li><a href="/docs/apa/donkey-bar#code_examples">Code Examples</a></li></ul></li><li><a href="/docs/apa/monkey-bar#monkey">Monkey Bar</a><ul><li><a href="/docs/apa/monkey-bar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><h1 id="donkey">Donkey Bar</h1><h2 id="code_examples">Code Examples</h2><h3 id="go">go</h3><pre><code class="language-go">var i = 0
...
func monkeyBarPageHandler(w http.ResponseWriter, req *http.Request) {
	...
	const content = `<!DOCTYPE html><html lang=en><head><title>Animal Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/docs/apa/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Animal Bars</h1><form class=menu-search action="/docs/apa/search" method="get"><input type="text" placeholder="Search.." name="q" value="" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/docs/apa#animal_bars">Animal Bars</a></li><li><a href="/docs/apa/donkey-bar#donkey">Donkey Bar</a><ul><li><a href="/docs/apa/donkey-bar#code_examples">Code Examples</a></li></ul></li><li><a href="/docs/apa/monkey-bar#monkey">Monkey Bar</a><ul><li><a href="/docs/apa/monkey-bar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><h1 id="monkey">Monkey Bar</h1><h2 id="code_examples">Code Examples</h2><h3 id="go">go</h3><pre><code class="language-go">var i = 0
</code></pre><h3 id="js">js</h3><pre><code class="language-javascript">let i = 0
</code></pre></div></div></body></html>`
...
<p><img src="/docs/service/static/animal-bars.svg" alt="The bars" /></p>`,
	...
	if err = searchIndex.Index("/docs/apa#animal_bars", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/apa/donkey-bar#donkey",
		Context: []string{ `Animal Bars`, `Donkey Bar`, },
		Content: []string{ `Donkey Bar`, },
		HTML: `<h1 id="donkey">Donkey Bar</h1>`,
	}

	if err = searchIndex.Index("/docs/apa/donkey-bar#donkey", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/apa/donkey-bar#code_examples",
		Context: []string{ `Animal Bars`, `Donkey Bar`, `Code Examples`, },
		Content: []string{ `Code Examples`, },
		HTML: `<h2 id="code_examples">Code Examples</h2>`,
	}

	if err = searchIndex.Index("/docs/apa/donkey-bar#code_examples", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/apa/donkey-bar#go",
...
<pre><code class="language-go">var i = 0
	...
	if err = searchIndex.Index("/docs/apa/donkey-bar#go", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/apa/donkey-bar#js",
...
<pre><code class="language-javascript">let i = 0
	...
	if err = searchIndex.Index("/docs/apa/donkey-bar#js", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/apa/monkey-bar#monkey",
		Context: []string{ `Animal Bars`, `Monkey Bar`, },
		Content: []string{ `Monkey Bar`, },
		HTML: `<h1 id="monkey">Monkey Bar</h1>`,
	}

	if err = searchIndex.Index("/docs/apa/monkey-bar#monkey", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/apa/monkey-bar#code_examples",
		Context: []string{ `Animal Bars`, `Monkey Bar`, `Code Examples`, },
		Content: []string{ `Code Examples`, },
		HTML: `<h2 id="code_examples">Code Examples</h2>`,
	}

	if err = searchIndex.Index("/docs/apa/monkey-bar#code_examples", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/apa/monkey-bar#go",
...
<pre><code class="language-go">var i = 0
	...
	if err = searchIndex.Index("/docs/apa/monkey-bar#go", doc); err != nil {
		return
	}

	doc = document{
		Link:    "/docs/apa/monkey-bar#js",
...
<pre><code class="language-javascript">let i = 0
	...
	if err = searchIndex.Index("/docs/apa/monkey-bar#js", doc); err != nil {
		return
	}
...
const searchPage = `<!DOCTYPE html><html lang=en><head><title>Animal Bars</title><meta name='generator' content='github.com/lonnblad/go-service-doc'><link rel="stylesheet" href="/docs/apa/markdown.css"></head><body class="markdown-body"><div class="flex-container"><div class="menu-container"><div  class=menu-header><h1>Animal Bars</h1><form class=menu-search action="/docs/apa/search" method="get"><input type="text" placeholder="Search.." name="q" value="<query_string>" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" autofocus /><button type="submit">Search</button></form></div><ul><li><a href="/docs/apa#animal_bars">Animal Bars</a></li><li><a href="/docs/apa/donkey-bar#donkey">Donkey Bar</a><ul><li><a href="/docs/apa/donkey-bar#code_examples">Code Examples</a></li></ul></li><li><a href="/docs/apa/monkey-bar#monkey">Monkey Bar</a><ul><li><a href="/docs/apa/monkey-bar#code_examples">Code Examples</a></li></ul></li></ul></div><div class="doc-container"><search_result></div></div></body></html>`
