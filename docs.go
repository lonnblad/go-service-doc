...
// 2021-02-27 19:05:44.008698006 +0000 UTC m=+0.104990623
package docs
  ...
  <div class="flex-container">
    <div class="menu-container">
      ...
      <div class=menu-content>
        <ul>
          <li><a href="/go-service-doc#bars">Bars</a></li>
...
func createSearchIndex() (searchIndex bleve.Index, err error) {
	...
	doc = document{
		Link:    "/go-service-doc#image",
		Context: []string{ `Bars`, `Bars`, `Image`, },
...
<p><img src="/go-service-doc/static/bars.svg" alt="The bars" /></p>`,
	...
	if err = searchIndex.Index("/go-service-doc#image", doc); err != nil {
		return
	}
